...
<html>
    ...
    <body>
        ...
        <div class="main-content-nologin">
            ...
            <h3 style='color:white; font-size: 20px; font-weight: bold; padding: 10px;'>Annuler un voyage</h3>

            <%
                String msgsucces = (String) request.getAttribute("messageSucces");
                if (msgsucces != null) {
                    out.println("<p style='background-color: green; color:white; font-weight: bold; padding: 10px;'>" + msgsucces + "</p>");
               }
                
                String msgerreur = (String) request.getAttribute("messageErreur");
                if (msgerreur != null) {
                    out.println("<p style='background-color: green; color:white; font-weight: bold; padding: 10px;'>" + msgerreur + "</p>");
                }
            %>

            <form id="voyage-form" method="post" action="Annulation">
                            ...
                            if (rvoyages.size() > 0) {
                                for (RVoyage v : rvoyages) {
                                    ...
                                    if ((stationD != null) && (stationA != null)) {
                                        ...
                                        out.println("<td><button type='submit' class='btn btn-primary' name='idVoyage' value='" + v.getId() + "'><span class='glyphicon glyphicon-remove' aria-hidden='true'></span></button></td>");
                                        out.println("</form>");
                                        out.println("</tr>");
                                    } else {
